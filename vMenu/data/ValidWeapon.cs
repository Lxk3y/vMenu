...
namespace vMenuClient.data
{
    ...
    public static class ValidWeapons
    {
        ...
        public static readonly Dictionary<string, string> weaponDescriptions = new()
        {
            ...
            // ADDON
            { "weapon_flashbang", string.Empty },
            { "weapon_spas12", string.Empty },
            { "weapon_fm1_remington700", string.Empty },
            { "weapon_hk417", string.Empty },
            { "weapon_m249", string.Empty },
            { "weapon_mcxspear", string.Empty },
            { "weapon_m4a1block2", string.Empty },
            { "weapon_hk416_spec", string.Empty },
            { "weapon_hk416", string.Empty },
            { "weapon_fm1_m9a3", string.Empty },
            { "weapon_fm1_p320", string.Empty },
            { "weapon_kvr", string.Empty },
            { "weapon_hkump", string.Empty },
            { "weapon_glock19", string.Empty },
            { "weapon_fm42", string.Empty },
            { "weapon_fm1_hk416", string.Empty },
            { "weapon_590", string.Empty },
            { "weapon_fm1_honeybadger", string.Empty },
            { "weapon_antler", string.Empty },
            { "weapon_christbat", string.Empty },
            { "weapon_christchair", string.Empty },
            { "weapon_christhammer", string.Empty },
            { "weapon_christmug", string.Empty },
            { "weapon_christree", string.Empty },
            { "weapon_sleigh", string.Empty },
            { "weapon_snowman", string.Empty },
            { "weapon_snowmannose", string.Empty },
            { "weapon_snowshovel", string.Empty },
            { "WEAPON_M4_T_NEON", string.Empty },
            { "WEAPON_GLACIER", string.Empty },
            { "WEAPON_HKUSP", string.Empty },
            { "WEAPON_HOWA_T20_CHR", string.Empty },
            { "WEAPON_VECOTR_CHR", string.Empty },
            { "WEAPON_BEANBAGSHOTGUN", string.Empty },
            { "weapon_gau_5a", string.Empty },
            { "weapon_beryl_762", string.Empty },
            { "weapon_modular_rifle", string.Empty },
            { "WEAPON_M4A5V2", string.Empty },
            { "WEAPON_AKPUV2", string.Empty },
            { "WEAPON_FAMAS_YELLOW", string.Empty },
            { "WEAPON_NVRIFLE_PURPLE", string.Empty },
            { "weapon_ak63_reaper", string.Empty },
            { "weapon_brx11_gloomjack", string.Empty },
            { "WEAPON_M4_HALLOWEEN", string.Empty },
            { "WEAPON_SCARN_DRACULA", string.Empty },
            { "WEAPON_SVK17_PUMPKIN", string.Empty },
            { "WEAPON_DSG19_NIGHTJACK", string.Empty },
            { "WEAPON_KDS45_HALLOWPUMP", string.Empty },
            { "WEAPON_RPD15_REAPER", string.Empty },
            { "WEAPON_M12_SPECTERWEB", string.Empty },
            { "WEAPON_SJ8_REAPER", string.Empty },
            { "weapon_fx9s_candyland", string.Empty },
            { "weapon_dz12_greenwitch", string.Empty },
        };
        ...
        public static readonly Dictionary<string, string> weaponNames = new()
        {
            ...
            { "weapon_spas12", GetLabelText("WT_SPAS12") },
            { "weapon_fm1_remington700", GetLabelText("WT_FM1_REM700") },
            { "weapon_hk417", GetLabelText("WT_HK417") },
            { "weapon_m249", GetLabelText("WT_M249") },
            { "weapon_mcxspear", GetLabelText("WT_MCXSPEAR") },
            { "weapon_m4a1block2", GetLabelText("WT_M4A1BLOCK2") },
            { "weapon_hk416_spec", GetLabelText("WT_HK416_SPEC") },
            { "weapon_hk416", GetLabelText("WT_HK416") },
            { "weapon_fm1_m9a3", GetLabelText("WT_M9A3") },
            { "weapon_fm1_p320", GetLabelText("WT_P320") },
            { "weapon_kvr", GetLabelText("WT_KVR") },
            { "weapon_hkump", GetLabelText("WT_HKUMP") },
            { "weapon_glock19", "Glock 19" },
            { "weapon_fm42", "FM42" },
            { "weapon_fm1_hk416", "HK416" },
            { "weapon_590", "S590" },
            { "weapon_fm1_honeybadger", "Honey Badger" },
            { "weapon_antler", "Antler" },
            { "weapon_christbat", "Christmas Bat" },
            { "weapon_christchair", "Christmas Chair" },
            { "weapon_christhammer", "Christmas Hammer" },
            { "weapon_christmug", "Christmas Mug" },
            { "weapon_christree", "Christmas Tree" },
            { "weapon_sleigh", "Sleigh" },
            { "weapon_snowman", "Snow Man" },
            { "weapon_snowmannose", "Snow Man Nose" },
            { "weapon_snowshovel", "Snow Shovel" },
            { "WEAPON_M4_T_NEON", "Neon Rifle" },
            { "WEAPON_GLACIER", "Glacier Rifle" },
            { "WEAPON_HKUSP", "HKUSP Auto Pistol" },
            { "WEAPON_HOWA_T20_CHR", "T20 Rifle" },
            { "WEAPON_VECOTR_CHR", "Vector SMG" },
            { "WEAPON_BEANBAGSHOTGUN", "Beanbag Shotgun" },
            { "weapon_gau_5a", "GAU5A Rifle" },
            { "weapon_beryl_762", "Beryl 762 Rifle" },
            { "weapon_modular_rifle", "Modular Rifle" },
            { "WEAPON_M4A5V2", "Aztecas Rifle" },
            { "WEAPON_AKPUV2", "Families Rifle" },
            { "WEAPON_FAMAS_YELLOW", "Vagos Rifle" },
            { "WEAPON_NVRIFLE_PURPLE", "Ballas Rifle" },
            { "weapon_ak63_reaper", "AK63 Reaper Rifle" },
            { "weapon_brx11_gloomjack", "Gloomjack Rifle" },
            { "WEAPON_M4_HALLOWEEN", "Halloween M4 Rifle" },
            { "WEAPON_SCARN_DRACULA", "Dracula Scar N Rifle" },
            { "WEAPON_SVK17_PUMPKIN", "SVK17 Pumpkin Rifle" },
            { "WEAPON_DSG19_NIGHTJACK", "NightJack SMG" },
            { "WEAPON_KDS45_HALLOWPUMP", "HallowPump SMG" },
            { "WEAPON_RPD15_REAPER", "RPD15 Reaper SMG" },
            { "WEAPON_M12_SPECTERWEB", "Spector Web Pistol" },
            { "WEAPON_SJ8_REAPER", "SJ8 Reaper Pistol" },
            { "weapon_fx9s_candyland", "FX9S Candyland Pistol" },
            { "weapon_dz12_greenwitch", "DZ12 Greenwitch Pistol" },
        };
        #endregion
        ...
        public static readonly Dictionary<string, Permission> weaponPermissions = new()
        {
            ...
            ["weapon_spas12"] = Permission.WPSpas12,
            ["weapon_fm1_remington700"] = Permission.WPFM1Remington700,
            ["weapon_hk417"] = Permission.WPHK417,
            ["weapon_m249"] = Permission.WPM249,
            ["weapon_mcxspear"] = Permission.WPMCXSpear,
            ["weapon_m4a1block2"] = Permission.WPM4A1Block2,
            ["weapon_hk416_spec"] = Permission.WPHK416Spec,
            ["weapon_hk416"] = Permission.WPHK416,
            ["weapon_fm1_m9a3"] = Permission.WPFM1M9A3,
            ["weapon_fm1_p320"] = Permission.WPFM1P320,
            ["weapon_kvr"] = Permission.WPKVR,
            ["weapon_hkump"] = Permission.WPHKUMP,
            ["weapon_glock19"] = Permission.WPGLOCK19,
            ["weapon_fm42"] = Permission.WPFM42,
            ["weapon_fm1_hk416"] = Permission.WPHK416,
            ["weapon_590"] = Permission.WP590,
            ["weapon_fm1_honeybadger"] = Permission.WPHONEYBADGER,
            ["weapon_antler"] = Permission.WPAntler,
            ["weapon_christbat"] = Permission.WPChristBat,
            ["weapon_christchair"] = Permission.WPChristChair,
            ["weapon_christhammer"] = Permission.WPChristHammer,
            ["weapon_christmug"] = Permission.WPChristMug,
            ["weapon_christree"] = Permission.WPChristRee,
            ["weapon_sleigh"] = Permission.WPSleigh,
            ["weapon_snowman"] = Permission.WPSnowMan,
            ["weapon_snowmannose"] = Permission.WPSnowManNose,
            ["weapon_snowshovel"] = Permission.WPSnowShovel,
            ["WEAPON_M4_T_NEON"] = Permission.WPNEONM4,
            ["WEAPON_GLACIER"] = Permission.WPGLACIER,
            ["WEAPON_HKUSP"] = Permission.WPHKUSP,
            ["WEAPON_HOWA_T20_CHR"] = Permission.WPT20CHR,
            ["WEAPON_VECOTR_CHR"] = Permission.WPVECTORCHR,
            ["WEAPON_BEANBAGSHOTGUN"] = Permission.WPBEANBAG,
            ["weapon_gau_5a"] = Permission.WPGAU5A,
            ["weapon_beryl_762"] = Permission.WPBERYL762,
            ["weapon_modular_rifle"] = Permission.WPMODULARRIFLE,
            ["WEAPON_M4A5V2"] = Permission.WPM4A5V2,
            ["WEAPON_AKPUV2"] = Permission.WPAKPUV2,
            ["WEAPON_FAMAS_YELLOW"] = Permission.WPFAMAS,
            ["WEAPON_NVRIFLE_PURPLE"] = Permission.WPNVRIFLE,
            ["weapon_ak63_reaper"] = Permission.WPAK63REAPER,
            ["weapon_brx11_gloomjack"] = Permission.WPGLOOMJACK,
            ["WEAPON_M4_HALLOWEEN"] = Permission.WPM4HALLOWEEN,
            ["WEAPON_SCARN_DRACULA"] = Permission.WPDRACULA,
            ["WEAPON_SVK17_PUMPKIN"] = Permission.WPPUMPKIN,
            ["WEAPON_DSG19_NIGHTJACK"] = Permission.WPNIGHTJACK,
            ["WEAPON_KDS45_HALLOWPUMP"] = Permission.WPHALLOWPUMP,
            ["WEAPON_RPD15_REAPER"] = Permission.WPRPD15REAPER,
            ["WEAPON_M12_SPECTERWEB"] = Permission.WPSPECTERWEB,
            ["WEAPON_SJ8_REAPER"] = Permission.WPSJ8REAPER,
            ["weapon_fx9s_candyland"] = Permission.WPCANDYLAND,
            ["weapon_dz12_greenwitch"] = Permission.WPGREENWITCH,
        };
        #endregion
        ...
        private static readonly Dictionary<string, string> weaponComponentNames = new()
        {
            ...
            // ADDON
            ["COMPONENT_M4A1BLOCK2_CLIP_03"] = GetLabelText("WCT_CLIP1"),
            ["COMPONENT_M4A1BLOCK2_FLSH_02"] = GetLabelText("WCT_FLASH"),
            ["COMPONENT_M4A1BLOCK2_FRAME_02"] = "Frame",
            ["COMPONENT_FMSCOPE_15"] = "Scope",
            ["COMPONENT_FMSTOCK_08"] = "Stock",
            ["COMPONENT_FMSUPP_03"] = GetLabelText("WCT_SUPP"),
            ["COMPONENT_FMGRIP_07"] = GetLabelText("WCT_GRIP"),
            ["COMPONENT_MCXSPEAR_SCOPE_10"] = "Scope",
            ["COMPONENT_MCXSPEAR_FLSH_01"] = GetLabelText("WCT_FLASH"),
            ["COMPONENT_MCXSPEAR_GRIP_03"] = GetLabelText("WCT_GRIP"),
            ["COMPONENT_FM1_M9A3_CLIP_02"] = GetLabelText("WCT_CLIP1"),
            ["COMPONENT_FMFLSH_01"] = GetLabelText("WCT_FLASH"),
            ["COMPONENT_FMSUPP_14"] = GetLabelText("WCT_SUPP"),
            ["COMPONENT_MARKOMODSKVR_HANDGUARD_2"] = GetLabelText("HANDGUARD"),
            ["COMPONENT_MARKOMODSKVR_STOCK_8"] = GetLabelText("STOCK"),
            ["COMPONENT_MARKOMODSKVR_SUPP_2"] = GetLabelText("WCT_SUPPRESSOR"),
            ["COMPONENT_MARKOMODSKVR_BARREL_3"] = GetLabelText("BARREL"),
            ["COMPONENT_UMP_SCOPE_04"] = GetLabelText("WCT_SCOPE_MED"),
            ["COMPONENT_UMP_SUPP_06"] = GetLabelText("WCT_SUPP"),
            ["COMPONENT_UMP_MOUNT_02"] = "Mount",
            ["COMPONENT_UMP_FLSH_06"] = GetLabelText("WCT_FLASH"),
            ["COMPONENT_UMP_GRIP_01"] = GetLabelText("WCT_GRIP"),
            ["COMPONENT_FMBIPOD_03"] = "Mount",
            ["COMPONENT_FM1_REMINGTON700_CLIP_02"] = GetLabelText("WCT_CLIP1"),
            ["COMPONENT_FMSUPP_28"] = GetLabelText("WCT_SUPP"),
            ["COMPONENT_FMSCOPE_02"] = "Scope",
            ["COMPONENT_HK417_FLSH_03"] = GetLabelText("WCT_FLASH"),
            ["COMPONENT_FMCLIP_12"] = GetLabelText("WCT_CLIP1"),
            ["COMPONENT_FMSTOCK_02"] = GetLabelText("WCT_SUPP"),
            ["COMPONENT_AT_SCOPE_hk416"] = GetLabelText("WCT_SCOPE_MED"),
            ["COMPONENT_FM1_P320_CLIP_02"] = GetLabelText("WCT_CLIP1"),
            ["COMPONENT_FM1_P320_FRAME_02"] = "Frame",
            ["COMPONENT_FM1_P320_SLIDE_02"] = "Slide",
            ["COMPONENT_FMSCOPE_30"] = "Scope",
            ["COMPONENT_MARKOMODSKVR_HANDGUARD_1"] = "Handguard",
            ["COMPONENT_MARKOMODSKVR_STOCK_4"] = "Stock",
            ["COMPONENT_MARKOMODSKVR_SUPP_3"] = "Suppressor",
            ["COMPONENT_MARKOMODS_SHARED_SCOPE_06"] = "Scope",
            ["COMPONENT_GLOCK19_GLOWSIGHT_01"] = "Glowsight",
            ["COMPONENT_GLOCK19_SLIDE_05"] = "Slide",
            ["COMPONENT_GLOCK19_CLIP_03"] = "Clip",
            ["COMPONENT_GLOCK19_FLSH_01"] = "Flashlight",
            ["COMPONENT_GLOCK19_SUPP_06"] = "Suppressor",
            ["COMPONENT_FM42_CLIP_02"] = "Clip2",
            ["COMPONENT_FM42_FLSH_01"] = "Flashlight1",
            ["COMPONENT_FMSUPP_01"] = "Suppressor1",
            ["COMPONENT_FMGRIP_02"] = "Grip2",
            ["COMPONENT_FMSCOPE_25"] = "Scope25",
            ["COMPONENT_FMCLIP_06"] = "Clip6",
            ["COMPONENT_FMSTOCK_09"] = "Stock9",
            ["COMPONENT_FMFLSH_10"] = "Flashlight10",
            ["COMPONENT_FMGRIP_03"] = "Grip3",
            ["COMPONENT_FMSUPP_19"] = "Suppressor19",
            ["COMPONENT_MARKOMODS590_STOCK_04"] = "Stock",
            ["COMPONENT_MARKOMODS590_GRIP_05"] = "Grip",
            ["COMPONENT_MARKOMODS590_MISC_05"] = "Barrel",
            ["COMPONENT_MARKOMODS_SHARED_SCOPE_01"] = "Scope1",
            ["COMPONENT_FMFLSH_16"] = "Flashlight16",
            ["COMPONENT_FMSCOPE_41"] = "Scope41",
            ["COMPONENT_FMCLIP_10"] = "Clip10",
            ["COMPONENT_GLOCK19_SCOPE_03"] = "Mini Sight",
            ["COMPONENT_GLOCK19_SLIDE_04"] = "Camo Slide",
            ["w_at_m4_tactical_neon_scope_small"] = "Scope",
            ["w_at_m4_tactical_neon_supp"] = "Suppressor",
            ["w_at_m4_tactical_neon_afgrip"] = "Foregrip",
            ["w_ar_m4_tactical_neon_mag2"] = "Magazine Style Two",
            ["w_ar_m4_tactical_neon_mag1"] = "Magazine Style One",
            ["w_ar_glacier_mag1"] = "Magazine Style 1",
            ["w_ar_glacier_mag2"] = "Magazine Style 2",
            ["w_at_ar_glacier_scope"] = "Scope",
            ["w_at_ar_glacier_supp"] = "Suppressor",
            ["w_at_ar_glacier_grip"] = "Foregrip",
            ["w_at_hkusp_supp"] = "Suppressor",
            ["w_at_hkusp_scope"] = "Scope",
            ["w_at_hkusp_flsh"] = "Flashlight",
            ["w_pi_hkusp_mag1"] = "Magazine Style 1",
            ["w_pi_hkusp_mag2"] = "Magazine Style 2",
            ["w_at_howat20_chr_afgrip"] = "Foregrip",
            ["w_at_howat20_chr_mod_supp"] = "Suppressor",
            ["w_at_howat20_chr_iron_sight"] = "Iron Sights",
            ["w_at_howat20_chr_mod_scope_small"] = "Scope",
            ["w_ar_howat20_chr_mag1"] = "Magazine Style 1",
            ["w_ar_howat20_chr_mag2"] = "Magazine Style 2",
            ["w_ar_howat20_chr_camo1"] = "Camo Style 1",
            ["w_ar_howat20_chr_camo2"] = "Camo Style 2",
            ["w_ar_howat20_chr_camo3"] = "Camo Style 3",
            ["w_sb_vector_chr_sight"] = "Sight",
            ["w_sb_vector_chr_supp"] = "Suppressor",
            ["w_sb_vector_chr_scope"] = "Scope",
            ["w_sb_vector_chr_afgrip"] = "Foregrip",
            ["w_sb_vector_chr_mag1"] = "Magazine Style 1",
            ["w_sb_vector_chr_mag2"] = "Magazine Style 2",
            ["w_sb_vector_chr_camo1"] = "Camo Style 1",
            ["w_sb_vector_chr_camo2"] = "Camo Style 2",
            ["w_sb_vector_chr_camo3"] = "Camo Style 3",
            ["w_ar_m4a5v2_mag1"] = "Magazine Style 1",
            ["w_ar_m4a5v2_mag2"] = "Magazine Style 2",
            ["w_at_m4a5v2_supp"] = "Suppressor",
            ["w_at_m4a5v2_sight"] = "Iron Sights",
            ["w_at_m4a5v2_scope"] = "Scope",
            ["w_at_m4a5v2_afgrip"] = "Foregrip",
            ["w_ar_nvrifle_purple_mag1"] = "Magazine Style 1",
            ["w_ar_nvrifle_purple_mag2"] = "Magazine Style 2",
            ["w_at_nvrifle_purple_supp"] = "Suppressor",
            ["w_at_nvrifle_purple_scope_sight"] = "Sight",
            ["w_at_nvrifle_purple_scope_small"] = "Scope",
            ["w_at_nvrifle_purple_afgrip"] = "Foregrip",
            ["w_at_ar_akpuv2_supp"] = "Suppressor",
            ["w_ar_akpuv2_mag1"] = "Magazine Style 1",
            ["w_ar_akpuv2_mag2"] = "Magazine Style 2",
            ["w_at_ar_akpuv2_scope"] = "Scope",
            ["w_at_ar_akpuv2_grip"] = "Foregrip",
            ["w_ar_famas_yellow_mag1"] = "Magazine Style 1",
            ["w_ar_famas_yellow_mag2"] = "Magazine Style 2",
            ["w_at_famas_yellow_scope"] = "Scope",
            ["w_at_famas_yellow_supp"] = "Suppressor",
            ["w_at_famas_yellow_sight"] = "Sight",
            ["w_at_beryl_762_afgrip"] = "Foregrip",
            ["w_at_beryl_762_supp"] = "Suppressor",
            ["w_at_beryl_762_scope_small"] = "Scope",
            ["w_ar_beryl_762_mag2"] = "Magazine Style 2",
            ["w_ar_beryl_762_mag1"] = "Magazine Style 1",
            ["w_at_gau_5a_afgrip"] = "Foregrip",
            ["w_at_gau_5a_mod_supp"] = "Suppressor",
            ["w_at_gau_5a_mod_scope_small"] = "Scope",
            ["w_ar_gau_5a_mag2"] = "Magazine Style 2",
            ["w_ar_gau_5a_mag1"] = "Magazine Style 1",
            ["w_at_modular_rifle_scope_small"] = "Scope",
            ["w_at_modular_rifle_scope_sight"] = "Sights",
            ["w_at_modular_rifle_afgrip"] = "Foregrip",
            ["w_at_modular_rifle_supp"] = "Suppressor",
            ["w_ar_modular_rifle_mag2"] = "Magazine Style 2",
            ["w_ar_modular_rifle_mag1"] = "Magazine Style 1",
            ["did_fx9s_candyland_mag1"] = "Magazine Style 1",
            ["did_fx9s_candyland_mag2"] = "Magazine Style 2",
            ["did_fx9s_candyland_flsh"] = "Flashlight",
            ["did_fx9s_candyland_scope"] = "Scope",
            ["did_fx9s_candyland_supp"] = "Suppressor",
            ["did_dz12_greenwitch_mag1"] = "Magazine Style 1",
            ["did_dz12_greenwitch_mag2"] = "Magazine Style 2",
            ["did_dz12_greenwitch_flsh"] = "Flashlight",
            ["did_dz12_greenwitch_scope"] = "Scope",
            ["did_dz12_greenwitch_supp"] = "Suppressor",
            ["did_ak63_reaper_mag1"] = "Magazine Style 1",
            ["did_ak63_reaper_mag2"] = "Magazine Style 2",
            ["did_ak63_reaper_scope"] = "Scope",
            ["did_ak63_reaper_supp"] = "Suppressor",
            ["did_brx11_gloomjack_mag1"] = "Magazine Style 1",
            ["did_brx11_gloomjack_mag2"] = "Magazine Style 2",
            ["did_brx11_gloomjack_afgrip"] = "Grip",
            ["did_brx11_gloomjack_supp"] = "Suppressor",
            ["w_ar_m4_halloween_camo1"] = "Camo Style 1",
            ["w_ar_m4_halloween_mag1"] = "Magazine Style 1",
            ["w_ar_m4_halloween_mag2"] = "Magazine Style 2",
            ["w_at_m4_halloween_scope"] = "Scope",
            ["w_at_m4_halloween_sight"] = "Iron Sight",
            ["w_at_m4_halloween_afgrip"] = "Grip",
            ["w_at_m4_halloween_supp"] = "Suppressor",
            ["did_scarn_dracula_mag1"] = "Magazine Style 1",
            ["did_scarn_dracula_mag2"] = "Magazine Style 2",
            ["did_scarn_dracula_scope"] = "Scope",
            ["did_scarn_dracula_supp"] = "Suppressor",
            ["did_scarn_dracula_afgrip"] = "Grip",
            ["did_svk17_pumpkin_mag1"] = "Magazine Style 1",
            ["did_svk17_pumpkin_mag2"] = "Magazine Style 2",
            ["did_svk17_pumpkin_scope"] = "Scope",
            ["did_svk17_pumpkin_supp"] = "Suppressor",
            ["did_svk17_pumpkin_afgrip"] = "Grip",
            ["did_dsg19_nightjack_afgrip"] = "Grip",
            ["did_dsg19_nightjack_flsh"] = "Flashlight",
            ["did_dsg19_nightjack_scope"] = "Scope",
            ["did_dsg19_nightjack_mag1"] = "Magazine Style 1",
            ["did_dsg19_nightjack_mag2"] = "Magazine Style 2",
            ["did_kds45_hallowpump_supp"] = "Suppressor",
            ["did_kds45_hallowpump_flsh"] = "Flashlight",
            ["did_kds45_hallowpump_scope"] = "Scope",
            ["did_kds45_hallowpump_mag1"] = "Magazine Style 1",
            ["did_kds45_hallowpump_mag2"] = "Magazine Style 2",
            ["did_m12_specterweb_supp"] = "Suppressor",
            ["did_m12_specterweb_flsh"] = "Flashlight",
            ["did_m12_specterweb_scope"] = "Scope",
            ["did_m12_specterweb_mag1"] = "Magazine Style 1",
            ["did_m12_specterweb_mag2"] = "Magazine Style 2",
            ["did_rpd15_reaper_afgrip"] = "Grip",
            ["did_rpd15_reaper_supp"] = "Suppressor",
            ["did_rpd15_reaper_flsh"] = "Flashlight",
            ["did_rpd15_reaper_scope"] = "Scope",
            ["did_rpd15_reaper_mag1"] = "Magazine Style 1",
            ["did_rpd15_reaper_mag2"] = "Magazine Style 2",
            ["did_sj8_reaper_supp"] = "Suppressor",
            ["did_sj8_reaper_scope"] = "Flashlight",
            ["did_sj8_reaper_flsh"] = "Scope",
            ["did_sj8_reaper_mag1"] = "Magazine Style 1",
            ["did_sj8_reaper_mag2"] = "Magazine Style 2",
        };
        #endregion
